//------------------------------------------------------------------------
// File         :  cbpm_dump_proc_params_a.c
...
int cbpm_dump_proc_params( FILE *fp, int iidx ) {

  CBPM_DATA *dp;
  dp = CTL_System.p_Module[iidx]->dsp_data;

  fprintf(fp, " Communication Structure Dump for: cbpm_proc_params\n");
  int  v0,  v1,  v2,  v3,  v4,  v5,  v6;
  int sv0, sv1, sv2, sv3, sv4, sv5, sv6;

  fprintf(fp, "avg_mode: %d  \n", dp->cbpm_proc_params.avg_mode);
